...
class PizzaHistoryAnnotations{
    ...
    init(){
        //Creekside Park - 37.3164° N, 122.0158° W
        var annotation = PizzaAnnotation( coordinate: CLLocationCoordinate2DMake(37.3164,122.0158), title: "Pizza Margherita", subtitle: "Street Food Nationalized")
